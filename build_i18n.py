...
TRANSLATIONS = {
    'en': {
        ...
        "註冊即享 15 美元訂閱優惠券！體驗極速流暢的全球實時圖表、編寫 Pine Script 自動化回測，本院量化策略首選推薦工具。": "Get a $15 coupon! Experience fast global charts and Pine Script backtesting. Recommended tool for quant strategies.",
        ...
        '通過下方 GugoPro 專屬連結註冊，您可在升級付費套餐時獲得 <strong style="color: #ffffff; font-size: 1.1rem;">15 美元</strong> 的折扣優惠券！': "Sign up through our exclusive link below to receive a <strong style='color:#ffffff;'>$15 coupon</strong> when upgrading to any paid plan!",
        "領取 15 美元註冊 TradingView": "Sign Up & Get $15 Discount on TradingView",
        ...
        "立即註冊並獲得 $15 抵扣 ➡️": "Sign Up Now & Save $15 ➡️",
    ...
    'ja': {
        ...
        "註冊即享 15 美元訂閱優惠券！體驗極速流暢的全球實時圖表、編寫 Pine Script 自動化回測，本院量化策略首選推薦工具。": "登録で15ドルクーポンプレゼント！世界最高水準の高速リアルタイムチャートやPineスクリプトによる自動バックテストをお試しください。",
        "領取優惠註冊": "15ドル割引で登録する",
        ...
        "🎁 好康回饋：": "🎁 受講生限定特典：",
        '通過下方 GugoPro 專屬連結註冊，您可在升級付費套餐時獲得 <strong style="color: #ffffff; font-size: 1.1rem;">15 美元</strong> 的折扣優惠券！': "以下のGugoPro専用リンクから登録すると、有料プランへのアップグレード時に <strong style='color:#ffffff;'>15ドル分</strong> の割引クーポンが適用されます！",
        "領取 15 美元註冊 TradingView": "15ドル割引でTradingViewに登録する",
        ...
        "立即註冊並獲得 $15 抵扣 ➡️": "今すぐ登録して15ドル割引を受け取る ➡️",

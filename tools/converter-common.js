    ...
    function initCommerce(targetId) {
        ...
        target.innerHTML = '<section class="converter-promo-grid" aria-label="合作與支持">' +
            '<article class="converter-promo-card tradingview">' +
                ...
                '<p>TradingView 提供全球市場圖表、Pine Script 回測與多資產研究工具；透過學院專屬連結註冊，可查看 30 天試用與現行優惠資格。</p>' +
            ...
            '<article class="converter-promo-card kofi">' +
                ...
                '<a class="converter-button" href="https://ko-fi.com/gugopro" target="_blank" rel="noopener sponsored">前往 Ko-fi 贊助 <i class="fa-solid fa-heart"></i></a>' +
            '</article>' +
        '</section>' +
